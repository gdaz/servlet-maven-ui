...
public class Service2Servlet extends HttpServlet {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Service2Servlet.class);
...
//            req.getRequestDispatcher("/pages/execution/service2.jsp").forward(req, resp);
            req.getRequestDispatcher("/WEB-INF/pages/service2.jsp").forward(req, resp);
//            resp.sendRedirect("/pages/service2.jsp");
        } catch (Exception e) {
